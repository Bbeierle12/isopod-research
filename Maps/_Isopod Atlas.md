...
Facet & pattern cross-reference. **Realm and research axes span all 11326 Isopoda species** (hobby + non-hobby); **husbandry facets** cover the 112 hobby forms. Generated by `scripts/atlas.py` (2026-07-26).
...
- [[By Realm|By Realm]] — 11339 classified
