...
> Every species note carries the research-filter fields (ecomorph, terrestrialization, habitat stratum, trophic guild, reproduction), populated only where studied (34 so far, evidence-graded a/b/c). No family-level guessing — add rows to `data/ecology.json` to classify more.
...
- [[By Trophic Guild|By Trophic Guild]] — 34 classified
